...
class TestBackend(TestBackendCommon):
    ...
    def test_change_email(self):
        ...
        logger.info("old email: %s", user_obj["email"])
        logger.info("new email: %s", new_email)
    ...
    def test_profile_update(self):
        ...
        if not status_ok:
            logger.info(response_change.text)
    ...
    def test_upload_avatar(self):
        ...
        logger.info("Avatar URL %s", str(download_url))
